...
if __name__ == '__main__':	
	...
	for vertice in grafo:
		...
		sumRota = reduce(operator.add, dicGrafo[vertice.getId()]['rota'])

		for vizinho in vertice.getVizinhos():

			rota1 = vertice.getId() + vizinho.getId()
			rota2 = vizinho.getId() + vertice.getId() 

			print rota1, " ou ", rota2, " --> ", sumRota, "\t", (rota1 in sumRota or rota2 in sumRota)
